...
<body>
	...
	Correo <br>
	<input type="text" name="Correo" required="" autocomplete="off" placeholder="Correo" value="<?php echo $Info['CORREO']; ?>"><br><br>
	Materia <br>
	...
	<option value="<?php echo $Info['DOCENTE']; ?>"><?php echo $Info['DOCENTE']?></option>
		...
		<option value="<?php $Docente['NOMBRE'].' '.$Docente['APELLIDO'] ?>"><?php echo $Docente['NOMBRE'].' '.$Docente['APELLIDO']; ?></option>	
